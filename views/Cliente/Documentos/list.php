...
<head>
    <meta charset="utf-8" />
    <title>Clientes - Documentos</title>
    ...
    <div class="wrapper">
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="btn-group pull-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                <li class="breadcrumb-item active">Documentos de Clientes</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <form action="?controller=Documentos&method=upload" method="post" enctype="multipart/form-data">
                    ...
                    <?php foreach ($documentos as $documento): ?>
                        <div class="col-lg-3 col-xl-2">
                            <div class="file-man-box">
                              ...
                              <!-- Formulario de eliminación dentro de un enlace -->
                            <form method="POST" action="?controller=Documentos&method=delete" style="display:inline;" onsubmit="return confirmDeletion()">
                            ...
                            <script>
                                ...
                                <a href="?controller=Documentos&method=downloadFile&id=<?php echo $documento['id_documento']; ?>" 
                                class="file-download" 
